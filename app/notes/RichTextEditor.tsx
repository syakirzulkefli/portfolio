...
const editorHtmlClassName = (isDark: boolean) =>
  [
    ...
    "[&_h3]:mt-3 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:leading-[1.2]",
    ...
    "[&_blockquote]:my-2 [&_blockquote]:border-l-4 [&_blockquote]:border-sky-400/50 [&_blockquote]:pl-4",
    "[&_img]:my-3 [&_img]:max-w-full [&_img]:rounded-xl [&_img]:border [&_img]:border-slate-700",
    "[&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:border [&_pre]:p-4 [&_pre]:font-mono [&_pre]:text-[13px] [&_pre]:leading-[1.35]",
