      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          {techStack.map((tech, index) => (
            <div
              key={index}
              className="inline-flex items-center justify-center mx-6 px-4 py-2 text-white/60 text-base font-medium tracking-wide"
