...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`md:hidden fixed inset-0 z-40 transition-opacity duration-300 ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}
        style={{
          backdropFilter: 'blur(20px)',
          background: 'linear-gradient(135deg, rgba(90, 103, 216, 0.9), rgba(0, 0, 0, 0.8))'
        }}
      >
